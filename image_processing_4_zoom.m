...
for i=1:h-1
    for j=1:w-1
        ...
        I3(i*2,j*2)=(I(i,j)+I(i+1,j)+I(i,j+1)+I(i+1,j+1))/4; %%sağ alt
        I3(i*2-1,j*2)=(I(i,j)+I(i+1,j))/2; %%sağ üst
        I3(i*2-1,j*2-1)=I(i,j); %%sol üst
        I3(i*2,j*2-1)=(I(i,j)+I(i,j+1))/2;
    end
end

figure,imshow(uint8(I2)),title("ZOOM-1.YÖNTEM")
figure,imshow(uint8(I3)),title("ZOOM-2.YÖNTEM")
